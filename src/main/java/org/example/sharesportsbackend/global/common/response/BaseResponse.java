package org.example.sharesportsbackend.global.common.response;

import static org.example.sharesportsbackend.global.common.response.BaseResponseStatus.*;
...
public record BaseResponse<T>(HttpStatusCode httpStatus, Boolean isSuccess, String message, T result) {
	...
	// 요청 실패
	public BaseResponse(org.example.sharesportsbackend.global.common.response.BaseResponseStatus status) {
